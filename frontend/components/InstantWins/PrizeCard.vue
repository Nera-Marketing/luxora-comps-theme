      ...
      <div v-if="isOpen" class="border-t border-gray-200 bg-gray-50 p-5 animate-fade-in-up">
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          <div
            ...
            :key="winnerIndex"
            class="relative min-w-0 px-3 py-5 bg-gradient-to-b from-amber-50 to-yellow-50 rounded-xl text-center shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border-2 border-amber-200 overflow-hidden group"
          >
            ...
            <div class="relative z-10">
              ...
              <!-- Winner Name -->
              <p
                class="text-sm font-bold text-gray-700 leading-snug wrap-anywhere hyphens-auto"
              >
                <span class="block" v-html="winner.details" />
              </p>
            </div>
          </div>
...
const showAllThreshold = 1;
const hasMore = computed(() => (props.prize.winners || []).length >= showAllThreshold);
