...
module.exports = {
  // Avoid colliding with the theme's Tailwind utilities on order-received (same class names, different output).
  prefix: 'ltyrs-',
  corePlugins: {
    // Do not ship Preflight globally — this stylesheet loads on order-received after the theme
    // and would reset WooCommerce / thank-you layout (full-bleed hero, stepper).
    preflight: false,
  },
  content: [
    './templates/**/*.php',
