		...
		<div class="options_group show_if_lottery">
			...
			woocommerce_wp_checkbox(
				array(
					...
					'default'     => 'no',
					'description' => __( 'When enabled, winners are assigned uniquely and same user cannot win multiple prizes. Note: Participants count must be equal or greater than Number of Winners count. If participants count is less than the winners count, then giveaway will fail without generating winners.', 'lottery-for-woocommerce' ),
					'desc_tip'    => true,
				)
			);
			woocommerce_wp_text_input(
