...
function nera_register_my_purpose_fields()
{
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [
        'key' => 'field_mp_hero_eyebrow',
        'label' => __('Eyebrow (kicker)', 'nera-competitions'),
        'name' => 'my_purpose_hero_eyebrow',
        'type' => 'text',
        'instructions' => __('Small uppercase line above the main headline.', 'nera-competitions'),
        'default_value' => __('The Story Behind Nera', 'nera-competitions'),
        'placeholder' => __('The Story Behind Nera', 'nera-competitions'),
      ],
      [
        'key' => 'field_mp_title',
      ...
      [
        'key' => 'field_mp_hero_tagline',
        'label' => __('Hero Tagline', 'nera-competitions'),
        'name' => 'my_purpose_hero_tagline',
        'type' => 'textarea',
        'instructions' => __('Italic line below the main headline (supports a short paragraph).', 'nera-competitions'),
        'default_value' => __('Building a community rooted in resilience, transparency, and the pursuit of a better life for everyone.', 'nera-competitions'),
        'rows' => 3,
      ],
      [
