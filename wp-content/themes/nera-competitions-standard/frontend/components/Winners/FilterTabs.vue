<template>
  <div ref="rootRef" class="flex justify-center mb-12">
    ...
    <div class="relative w-full md:hidden">
      ...
      <div class="absolute right-0 top-0 bottom-0 w-10 z-10 bg-gradient-to-l from-earthy-bg to-transparent pointer-events-none"></div>
      ...
      <div ref="mobileScrollRef" class="flex gap-2 overflow-x-auto hide-scrollbar px-4 py-2">
        <button
          ...
          :class="[
            activeFilter === filter.value
              ? 'bg-gradient-to-r from-earthy-terracotta-dark to-earthy-terracotta text-earthy-bronze shadow-earthy-terracotta-20'
              : 'bg-earthy-surface text-earthy-bronze-56 border border-earthy-bronze-20 active:bg-earthy-bronze-10',
        ...
        >
          ...
          <span
            ...
            :class="
              activeFilter === filter.value
                ? 'bg-earthy-bronze-20 text-earthy-bronze'
                : 'bg-earthy-bronze-10 text-earthy-bronze-56'
            "
          >{{ filter.count }}</span>
        </button>
      </div>
    ...
    <div class="hidden md:block">
      <div class="relative inline-flex bg-earthy-surface border border-earthy-bronze-20 rounded-xl p-1.5 gap-1">
        <!-- Sliding Background Indicator -->
        <div
          class="absolute h-[calc(100%-12px)] rounded-lg bg-gradient-to-br from-earthy-terracotta-dark to-earthy-terracotta shadow-lg transition-all duration-500 ease-out"
        ...
        <button
          ...
          :class="[
            activeFilter === filter.value
              ? 'text-earthy-bronze'
              : 'text-earthy-bronze-56 hover:text-earthy-bronze hover:-translate-y-0.5',
            disabled && activeFilter !== filter.value ? 'opacity-50' : '',
          ]"
        >
          ...
          <span
            ...
            :class="
              activeFilter === filter.value
                ? 'bg-earthy-bronze-20 text-earthy-bronze'
                : 'bg-earthy-bronze-10 text-earthy-bronze-56 hover:bg-earthy-bronze-15'
            "
          >
...
const indicatorStyle = computed(() => {
  ...
  return {
    ...
    boxShadow: 'var(--shadow-earthy-terracotta-20)',
  };
});
