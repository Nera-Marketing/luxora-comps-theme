      ...
      <div class="bg-mint-wash rounded-2xl border border-ink-20 hover:shadow-md transition-shadow">
        ...
        <div class="bg-gradient-to-r from-ink-4 to-transparent px-6 py-4 border-b border-ink-20">
          <div class="flex items-center justify-between">
            ...
            <?php if (!$address): ?>
              <span class="px-3 py-1 text-xs font-semibold text-amber-400 bg-[rgba(234,179,8,0.2)] border border-amber-500/30 rounded-full">
                Not set
              </span>
            <?php else: ?>
              <span class="px-3 py-1 text-xs font-semibold text-emerald-400 bg-[rgba(34,197,94,0.2)] border border-emerald-500/30 rounded-full">
                Active
              </span>
            <?php endif; ?>
          </div>
