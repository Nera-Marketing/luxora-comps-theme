...
<main id="primary" class="site-main bg-off-white min-h-screen flex items-center">
    <div class="container mx-auto px-4 py-16">

        <div class="max-w-2xl mx-auto text-center">

            <div class="mb-8">
                <span class="text-9xl font-bold text-sage/20">404</span>
            </div>
            ...
            <p class="text-xl text-ink-soft mb-8">
                <?php esc_html_e(
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <a href="<?php echo esc_url(
                  home_url('/'),
                ); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-forest to-sage text-ink font-semibold rounded-lg hover:opacity-90 transition-colors">
                ...
                <button onclick="history.back()" class="inline-flex items-center justify-center px-8 py-4 bg-white text-ink font-semibold rounded-lg border border-border hover:bg-mint/5 transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form role="search" method="get" class="flex gap-2" action="<?php echo esc_url(
                  home_url('/'),
                    ...
                    <input
                        ...
                        name="s"
                    >
                    <button type="submit" class="px-6 py-3 bg-gradient-to-r from-forest to-sage text-ink font-semibold rounded-lg hover:opacity-90 transition-colors">
