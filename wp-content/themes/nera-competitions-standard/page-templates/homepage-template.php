...
<main id="main" class="nera-homepage" role="main">
  ...
  $homepage_section_map = [
    ...
    'account_prompt' => 'template-parts/homepage/account-prompt',
    'stats' => 'template-parts/homepage/stats-section',
    'welcome' => 'template-parts/homepage/welcome-section',
  ...
  if (is_array($sections) && !empty($sections)) {
    ...
    get_template_part('template-parts/homepage/account-prompt');
    get_template_part('template-parts/homepage/welcome-section');
