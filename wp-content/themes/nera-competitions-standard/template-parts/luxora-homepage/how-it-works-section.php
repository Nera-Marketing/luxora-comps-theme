...
<section class="py-24 px-[60px] bg-mint-soft how-section" id="how-it-works">
  ...
  <?php if (is_array($steps) && !empty($steps)): ?>
    <div class="mt-[60px] grid grid-cols-3 gap-0.5 how-grid">
      <?php foreach (array_slice($steps, 0, 3) as $n => $step): ?>
        <div class="how-step bg-white py-11 px-8 relative overflow-hidden border border-[rgba(61,74,58,0.14)] rounded-none" data-n="<?php echo esc_attr($n + 1); ?>">
  ...
  <?php else: ?>
    <div class="mt-[60px] grid grid-cols-3 gap-0.5 how-grid">
      <div class="how-step bg-white py-11 px-8 relative overflow-hidden border border-[rgba(61,74,58,0.14)] rounded-none" data-n="1">
      ...
      <div class="how-step bg-white py-11 px-8 relative overflow-hidden border border-[rgba(61,74,58,0.14)] rounded-none" data-n="2">
      ...
      <div class="how-step bg-white py-11 px-8 relative overflow-hidden border border-[rgba(61,74,58,0.14)] rounded-none" data-n="3">
