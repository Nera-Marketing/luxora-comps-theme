...
<section class="py-24 px-[60px] bg-mint-wash winners-section">
  ...
  <?php if (is_array($list) && !empty($list)): ?>
    <div class="mt-12 grid grid-cols-4 gap-0.5 winners-grid">
      <?php foreach ($list as $winner): ?>
        <div class="winner-card bg-white py-[26px] px-[22px] border border-[rgba(61,74,58,0.14)] rounded-none">
