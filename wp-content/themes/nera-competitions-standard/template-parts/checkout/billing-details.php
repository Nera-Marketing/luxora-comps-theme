...
<div class="bg-white rounded-2xl border border-border p-6 lg:p-8" id="customer_details">

  <h2 class="text-xl font-bold text-ink mb-6 flex items-center gap-2">
    <span class="material-symbols-outlined text-sage">person</span>
  ...
  <?php if ($checkout->get_checkout_fields('order')): ?>
    <div class="mt-8 pt-6 border-t border-border">
      <h3 class="text-lg font-bold text-ink mb-4 flex items-center gap-2">
        <span class="material-symbols-outlined text-sage">edit_note</span>
