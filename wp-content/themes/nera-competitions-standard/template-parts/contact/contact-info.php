 ...
 *
 * Displays contact methods in a simple list format with left-aligned icons.
 *
...
$show_cards = function_exists('get_field') ? get_field('show_contact_cards') : true;
...
$email = function_exists('get_field') ? get_field('contact_email') : 'support@competition.com';
$phone = function_exists('get_field') ? get_field('contact_phone') : '+1 (555) 012-3456';

// Section content
$section_heading = function_exists('get_field')
  ? get_field('get_in_touch_heading')
  : __('Get in Touch', 'nera-competitions');
$section_description = function_exists('get_field')
  ? get_field('get_in_touch_description')
  : __(
    'Have questions about rules, deadlines, or partnerships? Reach out directly using the information below.',
    'nera-competitions',
  );
...
$linkedin = get_theme_mod('nera_linkedin_url', '');
?>

<div class="contact-info-section">
    <!-- Section Heading -->
    <h2 class="text-2xl lg:text-3xl font-heading font-bold text-ink mb-3">
        <?php echo esc_html($section_heading); ?>
    </h2>

    <p class="text-sage mb-8">
            ...
            <div class="flex gap-3 items-start">
                ...
                <div>
                    ...
                    <a href="<?php echo esc_url('mailto:' . $email); ?>"
                        class="text-ink hover:text-sage transition-colors break-all">
            ...
            <div class="flex gap-3 items-start">
                ...
                <div>
                    ...
                    <a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9+]/', '', $phone)); ?>"
                        class="text-ink hover:text-sage transition-colors">
    ...
    <?php if ($facebook || $twitter || $instagram || $linkedin): ?>
        <div class="border-t border-gray-200 pt-6">
            <p class="text-sm text-text-secondary mb-3">
                <?php _e('Follow us', 'nera-competitions'); ?>
            </p>
                ...
                <?php if ($facebook): ?>
                    <a href="<?php echo esc_url(
                      $facebook,
                        ...
                        class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors"
                        aria-label="Facebook">
