...
<div class="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center pt-12 lg:pt-20 pb-8 lg:pb-12">
    ...
    <?php if ($subheading): ?>
        <div class="flex justify-center mb-6" data-aos="fade-up">
            <span class="inline-flex items-center px-4 py-2 rounded-full bg-sage/20 text-sage text-sm font-semibold">
    ...
    <!-- Main Heading -->
    <h1 class="font-heading text-4xl lg:text-5xl xl:text-6xl font-bold text-ink mb-6" data-aos="fade-up" data-aos-delay="100">
        <?php echo esc_html($heading); ?>
    </h1>

    <!-- Description -->
    <?php if ($description): ?>
        <p class="text-lg lg:text-xl text-ink-soft leading-relaxed max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
