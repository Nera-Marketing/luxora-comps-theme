...
<section class="py-24  relative overflow-hidden" id="categories-competitions" data-aos="fade-up"
  ...
  <div class="max-w-[1200px] mx-auto px-4 relative z-10">
    ...
    <div class="mb-16 text-center">
      ...
      <div
        ...
        <span class="text-xs font-bold uppercase tracking-widest text-sage">Browse by Category</span>
      </div>

      <!-- Main Title -->
      <h2 class="text-5xl md:text-6xl font-black text-ink tracking-tight leading-[0.95] mb-4">
        <?php echo esc_html(
          ...
          <div class="flex flex-wrap items-center justify-center gap-3">
            ...
            <button @click.prevent="activeCategory = 'all'"
              ...
              <span class="inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-full text-xs font-bold"
                :class="activeCategory === 'all' ? 'bg-sage/20 text-ink' : 'bg-ink/10 text-ink-soft'">
                ...
                <button @click.prevent="activeCategory = '<?php echo esc_js($category_slug); ?>'"
                  ...
                  <span class="inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-full text-xs font-bold"
                    :class="activeCategory === '<?php echo esc_js(
                      $category_slug,
                    ); ?>' ? 'bg-sage/20 text-ink' : 'bg-ink/10 text-ink-soft'">
