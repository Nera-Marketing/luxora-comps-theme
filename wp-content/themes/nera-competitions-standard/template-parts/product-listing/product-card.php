      ...
      <?php if ($end_date_gmt && $countdown_timestamp > 0): ?>
        <div class="flex items-center gap-3 text-text-secondary"
          ...
          <div class="flex items-center gap-1 text-sm font-semibold">
            ...
            <span class="text-text-secondary/50">d</span>
            <span class="mx-0.5">:</span>
            <span x-text="hours">00</span>
            <span class="text-text-secondary/50">h</span>
            <span class="mx-0.5">:</span>
            <span x-text="minutes">00</span>
            <span class="text-text-secondary/50">m</span>
            <span class="mx-0.5">:</span>
            <span x-text="seconds">00</span>
            <span class="text-text-secondary/50">s</span>
          </div>
        </div>
      <?php endif; ?>
