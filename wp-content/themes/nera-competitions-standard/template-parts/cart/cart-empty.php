...
<div
  class="nera-cart-empty-state max-w-2xl mx-auto border border-border bg-white rounded-3xl p-12 overflow-hidden relative">
  ...
  <div class="relative z-10 flex flex-col items-center justify-center">
    ...
    <div class="relative mb-8 group">
      <div
        class="absolute inset-0 bg-gradient-to-tr from-forest rounded-full blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 animate-pulse-slow">
      </div>
      <div
        class="relative w-20 h-20 bg-off-white rounded-full flex items-center justify-center border border-border animate-float">
        <span
          class="material-symbols-outlined !text-2xl text-sage">shopping_cart_off</span>
      </div>
    </div>

    <!-- Main Heading -->
    <h2 class="text-3xl font-bold text-mint mb-3 text-center tracking-tight">
    ...
    <a href="<?php echo esc_url(
      ...
      class="group relative inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-forest text-mint font-bold text-lg overflow-hidden transition-all duration-300 hover:opacity-90 hover:-translate-y-1">
  ...
  <div class="mt-12 pt-10 border-t border-gray-100/80 relative z-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      ...
      <div class="flex flex-col items-center gap-2 group cursor-default">
        <div
          class="p-2 bg-[rgba(74,222,128,0.2)] rounded-full text-green-400 mb-1 transition-transform group-hover:scale-110 duration-300">
          <span class="material-symbols-outlined text-xl">verified_user</span>
        </div>
        <div>
          <h4 class="font-bold text-sm text-mint"><?php _e(
            'Guaranteed Draws',
            'nera-competitions',
          ); ?></h4>
          <p class="text-xs text-border6 mt-0.5"><?php _e(
      ...
      <div class="flex flex-col items-center gap-2 group cursor-default">
        <div
          class="p-2 bg-border rounded-full text-mint mb-1 transition-transform group-hover:scale-110 duration-300">
