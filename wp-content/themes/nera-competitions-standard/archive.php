...
<main id="primary" class="site-main bg-[#0c0b09] min-h-screen">
    <div class="container mx-auto px-4 py-12">
        ...
        <header class="mb-12 text-center">
            <?php
            the_archive_title('<h1 class="text-4xl font-bold text-[#d8b582] mb-4">', '</h1>');
            the_archive_description(
              '<div class="text-lg text-[rgba(216,181,130,0.56)] max-w-2xl mx-auto">',
              '</div>',
            );
            ?>
        </header>
  ...
  'bg-[#1e1c18] rounded-2xl border border-[rgba(216,181,130,0.2)] overflow-hidden transition-shadow',
                        ...
                        <div class="p-6">
                            <header class="mb-4">
                                ...
                                <div class="mt-2 text-sm text-[rgba(216,181,130,0.56)]">
                            ...
                            <a href="<?php the_permalink(); ?>" class="inline-flex items-center mt-4 text-[#c4704e] font-semibold hover:text-[#d8b582] transition-colors">
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16">
                <div class="max-w-md mx-auto">
                    ...
                    <h2 class="text-2xl font-bold text-[#d8b582] mb-2"><?php esc_html_e(
                      'No posts found',
                      'nera-competitions',
                    ); ?></h2>
                    <p class="text-[rgba(216,181,130,0.56)]"><?php esc_html_e(
