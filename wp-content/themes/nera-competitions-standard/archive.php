...
<main id="primary" class="site-main bg-off-white min-h-screen">
  ...
  'bg-white rounded-2xl border border-border overflow-hidden transition-shadow',
                        ...
                        <div class="p-6">
                            ...
                            <a href="<?php the_permalink(); ?>" class="inline-flex items-center mt-4 text-sage font-semibold hover:text-ink transition-colors">
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16">
                <div class="max-w-md mx-auto">
                    ...
                    <h2 class="text-2xl font-bold text-ink mb-2"><?php esc_html_e(
                      'No posts found',
                      'nera-competitions',
                    ); ?></h2>
                    <p class="text-ink-soft"><?php esc_html_e(
