...
if (function_exists('acf_add_local_field_group')) {
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [
        'key' => 'field_sp_winner_display_name',
        'label' => 'Winner Display Name Override',
        'name' => 'winner_display_name',
        'type' => 'text',
        'instructions' => 'Optional override for the winner\'s name shown in the archive.',
        'placeholder' => 'e.g., John D.',
      ],
      [
        'key' => 'field_sp_entry_list_file',
        'label' => 'Entry List PDF Override',
        'name' => 'entry_list_file',
        'type' => 'file',
        'instructions' => 'Upload a manual PDF entry list if you don\'t want to use the automated generator.',
        'return_format' => 'url',
        'library' => 'all',
        'mime_types' => 'pdf',
      ],
      [
        'key' => 'field_sp_draw_video_url',
        'label' => 'Draw Video URL',
        'name' => 'draw_video_url',
        'type' => 'url',
