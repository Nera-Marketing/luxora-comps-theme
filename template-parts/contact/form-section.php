...
<div class="nera-contact-form-wrapper bg-white rounded-2xl p-6 lg:p-8 border border-border">
    <!-- Form Header -->
    <?php if ($form_heading): ?>
        <h2 class="text-2xl font-heading font-bold text-ink mb-6 text-center">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
            ...
            <?php if (current_user_can('edit_pages')): ?>
                <a href="<?php echo esc_url(get_edit_post_link()); ?>"
                    class="inline-flex items-center gap-2 bg-forest text-mint px-4 py-2 rounded-lg hover:opacity-90 transition-colors text-sm font-medium">
