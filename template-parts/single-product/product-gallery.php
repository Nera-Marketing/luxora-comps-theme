...
// Build trimmed image data for Alpine lightbox (full-size only)
...
>
  ...
  <!-- Group wrapper: arrows appear on hover of main image OR thumbnails -->
  <div class="group">
  ...
  <div class="relative rounded-2xl overflow-hidden shadow-lg">
    ...
    <div class="swiper aspect-square" data-competition-main>
  ...
  <?php if (count($images) > 1 || $video_url): ?>
    <div class="mt-4">
      <div class="swiper gallery-thumbs-swiper" data-competition-thumbs>
        <div class="swiper-wrapper">
          <?php foreach ($images as $index => $image): ?>
  ...
  <!-- Lightbox (Alpine-controlled, SSR images) -->
  <div
    x-show="lightboxOpen"
    x-cloak
