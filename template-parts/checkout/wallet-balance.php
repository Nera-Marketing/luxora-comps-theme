...
<div class="nera-wallet-balance bg-white rounded-2xl border-2 border-border shadow-sm p-6 mb-6 hover:shadow-md hover:border-ink-30 transition-all duration-300">
  
  <!-- Header -->
  <div class="flex items-center justify-between mb-4">
    <div class="flex items-center gap-2">
      <span class="material-symbols-outlined text-sage text-2xl">account_balance_wallet</span>
  ...
  <!-- Balance Info -->
  <div class="bg-ink-5 rounded-xl p-4 mb-4 border border-border">
    <div class="flex items-start gap-3">
      <div class="flex-shrink-0 w-10 h-10 rounded-full bg-sage-20 flex items-center justify-center mt-0.5">
  ...
  <div class="flex items-center justify-between text-xs">
    <a href="<?php echo esc_url(wc_get_account_endpoint_url('woo-wallet')); ?>" 
       class="inline-flex items-center gap-1 text-sage hover:text-ink font-medium transition-colors">
  ...
  <div class="mt-4 pt-4 border-t border-border">
    <div class="flex items-center justify-center gap-2 text-xs text-ink-56">
      <span class="material-symbols-outlined text-sm text-sage">verified_user</span>
      <?php esc_html_e(
        'Wallet credit will be automatically applied at checkout',
        'nera-competitions',
      ); ?>
    </div>
  </div>
...
.nera-wallet-payment-highlighted {
  position: relative;
  background: rgba(107, 140, 107, 0.08) !important;
...
.nera-wallet-payment-highlighted:hover {
  ...
  box-shadow: 0 4px 6px -1px rgba(107, 140, 107, 0.15) !important;
}
