...
<section class="stats-section py-10 px-6 lg:px-20 bg-[#0c0b09] border-b border-[rgba(216,181,130,0.06)]" id="stats-section" data-aos="fade-up">
		...
		<div class="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
			...
			<div class="trustpilot-badge flex flex-col items-center md:items-start text-center md:text-left shrink-0">
				<div class="flex items-center gap-2 mb-1">
					<span class="text-xl lg:text-2xl font-bold italic text-[#d8b582] tracking-tight">Trustpilot</span>
					<div class="flex gap-0.5">
						<?php for ($i = 0; $i < 5; $i++): ?>
							<svg class="w-5 h-5 lg:w-6 lg:h-6 text-[#4ade80] fill-current" viewBox="0 0 24 24">
								<path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
							</svg>
						<?php endfor; ?>
					</div>
				</div>
				<p class="text-xs lg:text-sm text-[rgba(216,181,130,0.56)]">
					Excellent <span class="font-semibold text-[#d8b582]"><?php echo esc_html($tp_score); ?></span> out of 5 based
					on <span class="font-semibold text-[#d8b582]"><?php echo esc_html($tp_reviews); ?></span> reviews
				</p>
			</div>

			<!-- Right: Stats with Dividers -->
			<div class="stats-grid flex items-stretch justify-center md:justify-end divide-x divide-[rgba(216,181,130,0.2)]">

				<!-- Stat 1: Prizes Won -->
				<div class="stat-item px-6 lg:px-10 text-center">
					<div class="stat-value text-2xl lg:text-3xl font-bold mb-0.5 text-[#d8b582]">
						<span class="count-up" data-target="<?php echo esc_attr(
        $total_winners,
      ); ?>" data-suffix="+">0</span><span
							class="stat-suffix">+</span>
					</div>
					<div class="stat-label text-[10px] lg:text-xs font-semibold text-[rgba(216,181,130,0.56)] uppercase tracking-[0.15em]">
