...
<section class="py-24 bg-[#0c0b09] relative overflow-hidden" id="categories-competitions" data-aos="fade-up"
  ...
  <div class="max-w-[1200px] mx-auto px-4 relative z-10">
    ...
    <div class="mb-16 text-center">
      ...
      <div
        ...
        <span class="text-xs font-bold uppercase tracking-widest text-[#c4704e]">Browse by Category</span>
      </div>

      <!-- Main Title -->
      <h2 class="text-5xl md:text-6xl font-black text-[#d8b582] tracking-tight leading-[0.95] mb-4">
        <?php echo esc_html(
      ...
      <div class="flex items-center justify-center gap-4 max-w-2xl mx-auto">
        ...
        <p class="text-lg text-[rgba(216,181,130,0.56)] font-medium">
          <?php echo esc_html(
          ...
          <div class="flex flex-wrap items-center justify-center gap-3">
            ...
            <button @click.prevent="activeCategory = 'all'"
              ...
              :class="activeCategory === 'all' 
                ? 'bg-gradient-to-r from-[#9b5039] to-[#c4704e] text-[#d8b582] shadow-lg border-[rgba(216,181,130,0.3)]' 
                : 'bg-[#1e1c18] border-2 border-[rgba(216,181,130,0.2)] text-[rgba(216,181,130,0.56)] hover:border-[rgba(216,181,130,0.3)]'" role="tab"
              ...
              <span class="inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-full text-xs font-bold"
                :class="activeCategory === 'all' ? 'bg-[rgba(216,181,130,0.2)] text-[#d8b582]' : 'bg-[rgba(216,181,130,0.1)] text-[rgba(216,181,130,0.56)]'">
                ...
                <button @click.prevent="activeCategory = '<?php echo esc_js($category_slug); ?>'"
                  ...
                  <span class="inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-full text-xs font-bold"
                    :class="activeCategory === '<?php echo esc_js(
                      $category_slug,
                    ); ?>' ? 'bg-[rgba(216,181,130,0.2)] text-[#d8b582]' : 'bg-[rgba(216,181,130,0.1)] text-[rgba(216,181,130,0.56)]'">
    ...
    <?php if ($show_view_all): ?>
      <div class="text-center mt-16">
        <a href="<?php echo esc_url(home_url('/all-competitions')); ?>"
          class="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#9b5039] to-[#c4704e] text-[#d8b582] font-bold rounded-full shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-[rgba(155,80,57,0.3)] hover:-translate-y-0.5">
